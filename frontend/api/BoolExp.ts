// BoolAtomData
export interface BoolAtomDataInstance {
  type: string;
...
export class BoolAtomData implements BoolAtomDataInstance {
  ...
  static clone(instance: BoolAtomDataInstance, _deep: boolean): BoolAtomDataInstance {
  ...
  static is(obj: unknown): obj is BoolAtomDataInstance {
    return obj !== null && typeof obj === 'object' && '_type' in obj && (obj as any)._type === 'BoolAtomData';
  }
...
// BoolExpressionData
export interface BoolExpressionDataInstance {
  type: string;
  operator: 'and' | 'or' | 'not';
...
export class BoolExpressionData implements BoolExpressionDataInstance {
  ...
  static is(obj: unknown): obj is BoolExpressionDataInstance {
    return obj !== null && typeof obj === 'object' && '_type' in obj && (obj as any)._type === 'BoolExpressionData';
  }
