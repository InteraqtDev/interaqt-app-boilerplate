...
// Use process.cwd() to get project root, as this script is now in .claude/agents/scripts/
...
// Generated by .claude/agents/scripts/generate-aggregated-integration.ts
// Run: npx tsx .claude/agents/scripts/generate-aggregated-integration.ts
